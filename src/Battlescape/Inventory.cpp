 ...
 */
Inventory::Inventory(Game *game, int width, int height, int x, int y, bool base) : InteractiveSurface(width, height, x, y), _game(game), _selUnit(0), _selItem(0), _tu(true), _base(base), _mouseOverItem(0), _mouseOverSlot(0), _groundOffset(0), _animFrame(0)
{
 ...
 * @return Pointer to selected slot, or NULL if none.
 */
RuleInventory *Inventory::getMouseOverSlot() const
{
 ...
 * @param item Pointer to selected slot, or NULL if none.
 */
