...
// this should probably be any small screen touch-device, i don't know the defines for all of them so i'll cover android and IOS as i imagine they're more common
	...
	_info.push_back(OptionInfo("alternateBaseScreens", &alternateBaseScreens, false, "STR_ALTERNATE_BASE_SCREENS", "STR_GEOSCAPE"));
	_info.push_back(OptionInfo("weaponTransferClipMultiplier", &weaponTransferClipMultiplier, 0, "STR_WEAPON_CLIPS_MULTIPLIER", "STR_GEOSCAPE"));
